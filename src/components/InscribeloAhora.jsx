...
export default function InscribeloAhora() {
  return (
    <section
      ...
      className="w-full flex justify-center monserrat-bold bg-[url('img/lanfondo.png')] py-20 relative"
    >
      <img
        src={logovertical}
        alt="logo lerobotica"
      ...
      <div className="w-[290px] xs:w-[370px] sm:w-[630px] md:w-[760px] lg:w-[1030px] xl:w-[1250px] flex flex-col items-center">
        <h2 className="text-center text-4xl text-[#00aabc]">
          Inscribe a tu hij@ ahora para que disfrute <br />
          sus vacaciones con esta
          <span className="text-[#d21080]"> experiencia tecnológica</span>
        </h2>
        <button className="py-2 px-6 bg-[#f7b503] rounded-md text-4xl text-white mt-10">
          ¡INSCRIBELO AHORA!
        </button>
      </div>
    </section>
